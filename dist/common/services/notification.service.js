...
class NotificationService {
    client;
    constructor() {
        var serviceAccount = JSON.parse((0, node_fs_1.readFileSync)((0, node_path_1.resolve)("./src/config/social-media-app-7fa2a-firebase-adminsdk-fbsvc-a10150a321.json")));
