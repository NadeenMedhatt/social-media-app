...
router.post("/signup/gmail", async (req, res, next) => {
    const { result, status = 201 } = await auth_service_1.default.signupWithGmail(req.body, `${req.protocol}://${req.host}`);
    return (0, response_1.successResponse)({
        res,
        message: "Done",
        status,
...
router.post("/login/gmail", async (req, res, next) => {
    const account = await auth_service_1.default.loginWithGmail(req.body, `${req.protocol}://${req.host}`);
    return (0, response_1.successResponse)({
        res,
        message: "Done",
        status: 200,
